  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && pos && createPortal(
        <div ref={menuRef} className="fixed z-[200] grid max-h-[260px] animate-[dropdown-in_140ms_ease-out] gap-0.5 overflow-y-auto rounded-lg border border-line bg-panel2 p-[5px] shadow-[0_14px_34px_#000a]" style={{ top: pos.top, left: pos.left, width: pos.width }}>
          {options.map((o) => (
            <button
