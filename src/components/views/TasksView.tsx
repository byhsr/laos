  ...
  return (
    <>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'end', marginBottom: 24 }}>
        <div><span className="font-mono text-[10px] tracking-[1px] text-muted">WORKSPACE</span><h1 style={{ margin: 0, fontSize: 24 }}>Tasks</h1></div>
      </header>

      <div className="mb-5 max-w-[900px] rounded-[10px] border border-line bg-panel p-[18px]">
        <label className="mb-1.5 block text-[10px] font-semibold tracking-[0.08em] text-muted uppercase">Assign to</label>
        ...
        <label className="mb-1.5 block text-[10px] font-semibold tracking-[0.08em] text-muted uppercase">Task</label>
        ...
        <label className="mb-1.5 block text-[10px] font-semibold tracking-[0.08em] text-muted uppercase">Context (optional)</label>
      ...
      <div className="grid max-w-[900px] gap-2.5">
        ...
        {tasks.map((t: Task) => (
          <div key={t.id} className="rounded-[9px] border border-line bg-panel p-[16px]">
            ...
            {t.result && <pre className="mt-2 max-h-32 overflow-y-auto whitespace-pre-wrap rounded-[6px] border border-line bg-panel2 p-2 text-[11px] text-muted">{t.result}</pre>}
          </div>
        ))}
      </div>
    </>
