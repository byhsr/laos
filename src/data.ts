import type { Integration, ModelConfig, Tool } from './types';
...
export const integrations: Integration[] = [{id:'http', name:'HTTP client', kind:'Built in', enabled:true, configured:true, description:'Make permission-scoped HTTP requests.'}];
