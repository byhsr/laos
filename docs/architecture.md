...
| Views | `components/views/*` | Home, Agents, Canvas (workflows), Manager (Laos), Tasks, Workshop (Skills/Tools/Integrations/Knowledge/Runs), Settings (Models), plus the agent window. |
